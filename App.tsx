    ...
    <Section>
        <div className="grid md:grid-cols-2 gap-x-16 gap-y-12 items-center">
            <div className="md:order-2">
                 <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?q=80&w=300&auto=format&fit=crop" alt="Franz Badenhorst, founder of LeadLabs" className="rounded-2xl shadow-xl w-full h-auto object-cover aspect-square max-w-sm mx-auto" />
            </div>
