...
// Constants
// ===================================
const WHATSAPP_BOOKING_URL = "https://wa.me/27621779799?text=Hi+Franz,+I'd+like+to+book+a+seat+for+your+Meta+Ads+Webinar";
...
const CtaButton: FC<CtaButtonProps> = ({ href = WHATSAPP_BOOKING_URL, children, className = '' }) => (
  <a
    href={href}
  ...
  return (
    <div className="bg-white text-[#222] py-24 px-8">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 leading-[1.15]">
          Learn the System That Built R12.4 Million in Meta Sales
        </h1>
        <p className="text-xl md:text-2xl text-[#222] max-w-3xl mx-auto mb-6 leading-[1.6]">
...
const PromiseSection: FC = () => (
  <Section className="bg-[#f9f9ff]">
    <div className="text-center">
      <h2 className="text-4xl md:text-6xl font-bold text-center mb-16 text-[#222] leading-[1.15]">What You'll Learn Inside the Meta Ads System Webinar</h2>
    ...
    <Section className="bg-white">
        <div className="grid md:grid-cols-2 gap-x-16 gap-y-12 items-center">
            ...
            <div className="text-center md:text-left md:order-1">
                <h2 className="text-3xl md:text-5xl font-bold mb-6 text-[#222] leading-[1.15]">Results from My Meta Ads System</h2>
...
const WhatsIncluded: FC = () => (
    <Section className="bg-[#f9f9ff]">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-4xl md:text-6xl font-bold text-center mb-12 text-[#222] leading-[1.15]">What's Included When You Join</h2>
...
const Faq: FC = () => (
    <Section className="bg-white">
        <div className="max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-6xl font-bold text-center mb-12 text-[#222] leading-[1.15]">Common Questions</h2>
            <div>
    ...
    <footer className="bg-white text-[#222] border-t border-gray-200">
        <div className="max-w-[1200px] mx-auto py-16 px-8">
            <div className="text-center mb-8">
                <h2 className="text-3xl md:text-5xl font-bold mb-6 text-[#222] leading-[1.15]">Ready to see how profitable Meta ads are actually built?</h2>
